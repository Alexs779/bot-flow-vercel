...
const renderEvents = () => (
                ...
                <div className="event-card__body">
                  ...
                  <div className="event-card__meta">
                    <div className="event-card__meta-item">
                      <span aria-hidden="true" className="event-card__emoji">📅</span>
  ...
  return (
    ...
    <div className="app">
      <main className="landing">
        ...
        {view === "stage" ? (
          <div className="landing__actions">
            ...
            <div className="landing__bottom-controls">
              <button
                type="button"
                className="landing__control landing__control--settings"
                onClick={() => setIsSettingsPanelOpen(true)}
                aria-expanded={isSettingsPanelOpen}
                aria-controls="settings-panel"
              >
                {authStatus === "authenticated" && telegramUser ? (
                  <div className="landing__control--user-info">
                    <div className="landing__control--user-avatar">
                      {telegramUser.avatar ? (
                        <img src={telegramUser.avatar} alt="Avatar" />
                      ) : (
                        <span>{telegramUser.firstName?.[0]}{telegramUser.lastName?.[0]}</span>
                      )}
                    </div>
                    <div className="landing__control--user-details">
                      <div className="landing__control--user-name">
                        {telegramUser.firstName} {telegramUser.lastName}
                      </div>
                      <div className="landing__control--user-id">ID: {telegramUser.id}</div>
                    </div>
                  </div>
                ) : (
      ...
      {isSettingsPanelOpen ? (
        <div className="settings-panel" role="dialog" aria-modal="true" aria-labelledby="settings-panel-title" id="settings-panel">
          <button
            type="button"
          ...
          <div className="settings-panel__content">
            <header className="settings-panel__header">
              <h2 className="settings-panel__title" id="settings-panel-title">Настройки</h2>
              <button
                type="button"
            ...
            <div className="settings-panel__body">
              {telegramUser && (
                <section className="settings-panel__section">
                  <h3 className="settings-panel__section-title">Профиль Telegram</h3>
                  <div className="settings-panel__profile">
                    <div className="settings-panel__avatar">
                      {telegramUser.avatar ? (
                        <img src={telegramUser.avatar} alt="Avatar" />
                      ) : (
                        <div className="settings-panel__avatar-placeholder">
                          {telegramUser.firstName?.[0]}{telegramUser.lastName?.[0]}
                        </div>
                      )}
                    </div>
                    <div className="settings-panel__user-info">
                      <div className="settings-panel__name">
                        {telegramUser.firstName} {telegramUser.lastName}
                      </div>
                      {telegramUser.username && (
                        <div className="settings-panel__username">@{telegramUser.username}</div>
                      )}
                      <div className="settings-panel__id">ID: {telegramUser.id}</div>
                    </div>
                  </div>
                </section>
              )}
              <section className="settings-panel__section">
                <h3 className="settings-panel__section-title">Статистика</h3>
                <div className="settings-panel__stats">
                  <div className="settings-panel__stat">
                    <span className="settings-panel__stat-label">Уровень</span>
                    <span className="settings-panel__stat-value">{level}</span>
                  </div>
                  <div className="settings-panel__stat">
                    <span className="settings-panel__stat-label">Flow</span>
                    <span className="settings-panel__stat-value">{formatNumber(balance)}</span>
                  </div>
                  <div className="settings-panel__stat">
                    <span className="settings-panel__stat-label">Мощность</span>
                    <span className="settings-panel__stat-value">+{tapPower}</span>
                  </div>
                  <div className="settings-panel__stat">
              ...
              <section className="settings-panel__section">
                <h3 className="settings-panel__section-title">Отладка</h3>
                <div className="settings-panel__debug">
                  <button
                    type="button"
                    className="settings-panel__debug-button"
                  ...
                  <div className="settings-panel__debug-info">
                    <p>Просмотр логов аутентификации и отладочной информации</p>
                  </div>
                </div>
              </section>
            </div>
